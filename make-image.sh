...
luci-proto-modemmanager usb-modeswitch xmm-modem luci-proto-xmm"
...
PACKAGES+=" luci-app-netmonitor luci-app-mmconfig"
...
if [ -z "${1:-}" ]; then
    ...
    echo "Tunnel Options: openclash, nikki, insomclash, nikki-passwall, openclash-nikki, openclash-insomclash, openclash-nikki-passwall"
    exit 1
fi
